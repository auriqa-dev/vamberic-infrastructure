...
3. Build the API image, authenticate Docker to the emitted ECR repository URI, and push it with an immutable release tag. Dev currently uses `d5bfe09`. Do not use `latest`.
